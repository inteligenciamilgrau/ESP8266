...
#define WLAN_SSID       "sua_rede_wifi"             // Your SSID
#define WLAN_PASS       "sua_senha"        // Your password
...
Adafruit_MQTT_Subscribe Light1 = Adafruit_MQTT_Subscribe(&mqtt, AIO_USERNAME "/feeds/lampada"); // Crie aqui sua variavel
